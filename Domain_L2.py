...
class Domain():
    def __init__(self):
        ...
        self.step_9 = [9, 'X1\'=', 'Уравнения для определения оптимальной траектории. Введите правую часть первого уравнения:', 'Первое уравнение для определения оптимальной траектории:']
        self.step_10 = [10, 'X2\'=', 'Уравнения для определения оптимальной траектории. Введите правую часть второго уравнения:', 'Второе уравнение для определения оптимальной траектории:']
        self.step_11 = [11, 'X3\'=', 'Уравнения для определения оптимальной траектории. Введите правую часть третьего уравнения:', 'Третье уравнение для определения оптимальной траектории:']
        ...
        self.step_12_2 = [12, 'U1opt=', 'Введите U1-оптимальное при |U1| <= U1max:', 'U1-оптимальное:']
        self.step_13_2 = [13, 'U2opt=', 'Введите U2-оптимальное при |U2| <= U2max:', 'U2-оптимальное:']
    ...
    def equation_template(self):
        ...
        self.eq_tmp_p2 = [us12, us22, us32, H2, Lg2, sx12, sx22, sx32, P1T, P2T, P3T, dfl2, u1o2, u2o2, X1d2, X2d2, X3d2]
    ...
    def make_latex(self, variant_i):
        ...
        self.latex_2_p1 = r'$\int_{t_0}^{t_1} (' + self.var_latex[5] + r'x_1+' + self.var_latex[6] + r'x_2) dt' + self.var_latex[7] + r'=0$'
        self.latex_3_p1 = r'$\int_{t_0}^{t_1} (' + self.var_latex[8] + r'x_1+' + self.var_latex[9] + r'x_2) dt' + self.var_latex[10] + r'=0$'
